...
List<HarryPotterChar> harryPotterCharFromJson(String str) =>
    List<HarryPotterChar>.from(
      json.decode(str).map((x) => HarryPotterChar.fromJson(x)),
    );

String harryPotterCharToJson(List<HarryPotterChar> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class HarryPotterChar {
  final String? id;
  final String? name;
  ...
  factory HarryPotterChar.fromJson(Map<String, dynamic> json) =>
      HarryPotterChar(
        id: json["id"],
        name: json["name"],
